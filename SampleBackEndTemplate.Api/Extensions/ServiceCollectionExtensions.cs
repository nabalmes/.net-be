using SampleBackEndTemplate.Api.Services;
using SampleBackEndTemplate.Application.DTOs.Settings;
...
using SampleBackEndTemplate.Infrastructure.Identity.Services;
using SampleBackEndTemplate.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\SampleBackEndTemplate.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "SampleBackEndTemplate",
